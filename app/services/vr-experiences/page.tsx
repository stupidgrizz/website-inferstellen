...
export default function VRExperiencesPage() {
  const service = {
    ...
    fullDescription:
      "Our VR Experiences service creates fully immersive virtual environments that transport users into digital worlds with unprecedented realism and interactivity. We develop custom VR applications for training, education, entertainment, and business presentations, utilizing cutting-edge haptic feedback and spatial tracking technologies to deliver truly transformative experiences.",
    ...
    technologies: ["Unity", "Unreal Engine", "Oculus SDK", "SteamVR", "WebXR", "OpenXR", "VRTK", "Haptic SDK"],
    category: "vr-experiences",
    year: "2024",
    specialization: "Immersive Virtual Reality",
    duration: "4-16 weeks",
    challenge:
      "Creating immersive VR experiences that feel natural and intuitive while maintaining high performance and comfort across different VR platforms and hardware configurations.",
    solution:
      "We utilize advanced VR development frameworks and optimization techniques to ensure smooth performance and comfortable user experiences. Our approach includes extensive user testing, ergonomic design principles, and adaptive rendering to accommodate various VR headsets and user preferences.",
    results: [
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto max-w-7xl px-4 md:px-6">
            ...
            >
              ...
              <div className="aspect-[4/1] rounded-xl overflow-hidden shadow-lg border border-border/40 bg-gradient-to-r from-background to-muted/20 mb-12">
                <img
                  src="/placeholder.svg?key=vrexp"
                  alt="VR Experiences Service Banner"
                ...
                <div className="relative">
                  <div className="aspect-video rounded-xl overflow-hidden shadow-2xl border border-border/40 bg-gradient-to-b from-background to-muted/20">
                    <iframe
                      ...
                      title="VR Experiences Service Video"
        ...
        <section className="w-full py-20 md:py-32 bg-gradient-to-br from-primary to-primary/80 text-primary-foreground">
          <div className="container mx-auto max-w-7xl px-4 md:px-6">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6">Ready to Enter Virtual Worlds?</h2>
              <p className="text-primary-foreground/80 md:text-lg mb-8">
                Let's create immersive VR experiences that transport your users into extraordinary virtual environments.
              </p>
